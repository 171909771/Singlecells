...
step1 用poisson分布拟合（细胞测序深度 和 每个基因对应的每个细胞的表达值）
=====
##### 预处理数据
```
...
```
##### tcrossprod对数据格式的要求，如下
<img src="https://user-images.githubusercontent.com/41554601/184671934-4eb5e8f8-92d0-45c3-b409-724a8973b4e7.png" width="375">
<img src="https://user-images.githubusercontent.com/41554601/184672026-4908aa86-b2fc-4f8a-9354-0fa5bf3413aa.png" width="375">
...
参考资料
---
- https://mp.weixin.qq.com/s/SJVwtnzx1Rx68UK3RcQe4w  # 中文解读关键函数
- https://www.jianshu.com/p/21b2f08652ed  # 中文解读SCTransfrom数据
- https://htmlpreview.github.io/?https://github.com/satijalab/sctransform/blob/supp_html/supplement/variance_stabilizing_transformation.html   # 原文示例
